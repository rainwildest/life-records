...
export class Migration20211106010046 extends Migration {
  async up(): Promise<void> {
    this.addSql('CREATE EXTENSION IF NOT EXISTS "uuid-ossp";');

    this.addSql(
      'create table "fund_plan" ("id" uuid not null default uuid_generate_v4(), "seq_id" serial primary key, "created_at" timestamptz(0) not null default current_timestamp, "modified_at" timestamptz(0) null, "deleted_at" timestamptz(0) null, "expense_id" varchar(255) not null, "name" varchar(255) null, "user_id" varchar(255) null, "amounts" int4 not null default 0, "approximate_at" timestamptz(0) null, "complete_at" timestamptz(0) null);'
    );
    this.addSql("comment on table \"fund_plan\" is '资金计划';");

    this.addSql(
      'create table "account_books" ("id" uuid not null default uuid_generate_v4(), "seq_id" serial primary key, "created_at" timestamptz(0) not null default current_timestamp, "modified_at" timestamptz(0) null, "deleted_at" timestamptz(0) null, "name" varchar(255) not null, "user_id" varchar(255) null);'
    );
