...
export class Migration20210924032346 extends Migration {
  async up(): Promise<void> {
    this.addSql('CREATE EXTENSION IF NOT EXISTS "uuid-ossp";');

    this.addSql(
      'create table "budgets" ("seq_id" serial primary key, "id" uuid not null default uuid_generate_v4(), "created_at" timestamptz(0) not null default current_timestamp, "modified_at" timestamptz(0) null, "deleted_at" timestamptz(0) null, "user_id" varchar(255) null, "expense_id" varchar(255) not null, "amount" varchar(255) not null);'
    );
