  ...
  return (
    <PageContent className="pt-24" ptr onPtrRefresh={onRefresh}>
      <div className="px-4 pt-4 pb-10">
        <div className="shadow-3 rounded-lg px-3 py-3 flex justify-between items-center mb-7">
        ...
        <ClassificationContainer details={data?.statisticalExpenditureOrIncome || []} type="pay" />

        {/* 如果预算为空则不显示 */}
        {!!(budgetsData?.statisticalBudget || []).length && <BudgetContainer details={budgetsData?.statisticalBudget || []} />}
      </div>
    </PageContent>
  );
};
